// Íconos de línea (estilo profesional), heredan el color con currentColor.
// Uso: <Icon name="printer" className="w-4 h-4" />
const PATHS = {
  package: (
    <>
  ...
  wrench: (
    <path d="M14.7 6.3a4 4 0 0 0-5.66 5.66l-6.04 6.04a2 2 0 1 0 2.83 2.83l6.04-6.04a4 4 0 0 0 5.66-5.66l-2.54 2.54-2.83-2.83 2.54-2.54z" />
  ),
  check: (
    <>
  ...
  alert: (
    <>
      <path d="M10.3 3.2 2.6 17a2 2 0 0 0 1.75 3h15.3a2 2 0 0 0 1.75-3L13.7 3.2a2 2 0 0 0-3.4 0z" />
  ...
  spray: (
    <>
      ...
      <path d="M18 4h.01M20.5 5.5h.01M18 8h.01M20.5 9.5h.01" />
    </>
  ),
  hammer: (
    <>
      <path d="M14 3.5 20.5 10 17.5 13 11 6.5z" />
      <path d="M12.5 8 4 16.5a2.12 2.12 0 1 0 3 3L15.5 11" />
    </>
  ),
  align: (
    <>
  ...
  sparkles: (
    <>
      ...
      <path d="M18 14.5l.6 1.9 1.9.6-1.9.6-.6 1.9-.6-1.9-1.9-.6 1.9-.6z" />
    </>
  ),
  whatsapp: (
    <>
