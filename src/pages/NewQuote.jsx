...
export default function NewQuote() {
  ...
  // Autoguardado silencioso: la cotización nueva en blanco se guarda en cada
        ...
        <div className="relative flex items-center justify-between gap-4">
          <div>
            <span className="inline-block text-[11px] font-semibold uppercase tracking-wide bg-white/10 px-2.5 py-1 rounded-full">
              {editando ? `Editando · ${original?.numero}` : "Nueva cotización"}
            </span>
            <h1 className="text-2xl sm:text-3xl font-extrabold mt-2">
              {editando ? "Editar cotización" : "Cotización"}
            </h1>
            <p className="text-white/60 mt-1 text-sm max-w-md">
              {editando
                ...
                : "Llena los datos, valora piezas y mano de obra. Se guarda solo mientras escribes; al generar se crea el PDF y, si el chasis coincide con un caso, queda enlazada."}
            </p>
          </div>
