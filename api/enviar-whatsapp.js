...
export default async function handler(req, res) {
  ...
  const { to, nombre, fecha, hora, vehiculo, servicio, esHoy, esActualizacion } = req.body || {};
  ...
  const text = textoCita(
    { nombre, fecha, hora, vehiculo, servicio, esHoy },
    esActualizacion ? "actualizacion" : "confirmacion"
  );
